import { type Game, type GameEventListener, type GameEventTick } from "../Game";
import { type Building, type BuildingCost, type BuildingKind } from "../Game/BuildingsController";
